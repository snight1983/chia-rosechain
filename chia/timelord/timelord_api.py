    ...
    async def new_peak_timelord(self, new_peak: timelord_protocol.NewPeakTimelord):
        ...
        async with self.timelord.lock:
            ...
            if new_peak.reward_chain_block.weight > self.timelord.last_state.get_weight():
                ...
                print("[new_peak_timelord] get new peak width:",
                      new_peak.reward_chain_block.weight)
            elif (
                ...
                self.timelord.new_peak = new_peak
                print("[new_peak_timelord] warning block that we don't have, changing to it:",
                      new_peak.reward_chain_block.weight)
    ...
    async def new_unfinished_block_timelord(self, new_unfinished_block: timelord_protocol.NewUnfinishedBlockTimelord):
        ...
        async with self.timelord.lock:
            ...
            if sp_iters > ip_iters:
                ...
                print(
                    "[new_unfinished_block_timelord] AAAAAAAAAA Overflow unfinished Non-overflow total_unfinished:", self.timelord.total_unfinished)
                ...
                if new_block_iters:
                    ...
                    print(
                        "[new_unfinished_block_timelord] BBBBBBBB Non-overflow unfinished block total_unfinished:", self.timelord.total_unfinished)
