...
# the output will be printed to your chia root path, e.g. ~/.chiarose/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.chiarose/mainnet/profile | less -r
...
#   python chia/utils/profiler.py ~/.chiarose/mainnet/profile 10 20
